...
@section('contenido')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div>
                <a href="{{ route('valordev.create') }}" class="btn btn-success">
            ...
            <table id="dt-products" class="table table-striped table-bordered dts" >
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Valor Devolución</th>
                        <th class="text-center">Acciones</th>
                    </tr>
                </thead>
                    @foreach ($valordev as $tag)
                        <tr class="text-center">
                            <td>{{ $tag->created_at }}</td>
                            <td>${{ number_format($tag->valor) }}</td>
                            <td>                                
                                <form action="{{ route('valordev.destroy', $tag->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
